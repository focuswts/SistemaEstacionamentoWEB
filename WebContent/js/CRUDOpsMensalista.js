$(document).ready(
		function() {
			...
			function render(data) {
				...
				$('#tabela').append(tHead);
				var rowH = "<tr> " + "<th>ID</th>" + "<th>Mensalista</th>" + "<th>CPF</th>"
				...
				$.each(data, function(index, value) {
					...
					var row1 = $("<td>" + value.idMensalista + "</td>");

					var row2 = $("<td>" + value.nomeMensalista + "</td>");

					var row3 = $("<td>" + value.cpfMensalista + "</td>");
					
					var row4 = $("<td>" + value.statusMensalista + "</td>");
			...
			function setInputData(event) {
				...
				if ($('#tf_Id').val() != null) {
					button.val("Atualizar Mensalista");
				} else if ($('#tf_Id').val() == null) {
					button.val("Inserir Mensalista");
				}
			...
			function getInputData(operacao) {
				...
				var statusMensalista = $('#slc_Status').attr('selected', true)
						.val();
				// alert(statusEstado);
