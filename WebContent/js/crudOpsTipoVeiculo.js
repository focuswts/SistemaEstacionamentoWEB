				...
				function() {
					...
					function render(data) {
						...
						$.each(data,
								function(index, value) {
									...
									var row1 = $("<td>" + value.idTipoV
											+ "</td>");

									var row2 = $("<td>" + value.descTipoV
											+ "</td>");

									var row3 = $("<td>" + value.statusTipoV
											+ "</td>");
					...
					function setInputData(event) {
						...
						$.each($('#slc_Status').children(), function(k, v) {
							...
							// é igual
							// Ao valor do OPTION
							if ($(v).text().toLowerCase() === statusTipoV
									.toLowerCase()) {
					...
					function getInputData(operacao) {
						...
						var statusTipoV = $('#slc_Status').attr('selected',
								true).val();
						// alert(statusEstado);
